...
def init_db():
    ...
    with Session(engine) as session:
        ...
        connection_settings = [
            ConnectionSetting(program_uid="6a09f20a-8de6-11e1-b3e1-001617ec3f2a",url="http://0.0.0.0:8080",client_login="Администратор",client_pass=""),
            ConnectionSetting(program_uid="e23429d1-c015-4d4b-8ab5-3f0689ef9805",url="http://0.0.0.0:8080",client_login="",client_pass="", endpoint="process"),
        ]
