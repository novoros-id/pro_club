...
def create_file_user_config (user_name):
    ...
    user_folder_pdf = io_file_operation.return_user_folder_pdf(user_name)
    user_folder_input = io_file_operation.return_user_folder_input(user_name)
    user_folder_doc = io_file_operation.return_user_folder_db(user_name)
    ...
    if not os.path.exists(config_path):
        ...
        data = {
            "folder_input": user_folder_input,
            "folder_db": user_folder_doc,
            "folder_pdf": user_folder_pdf
        }
